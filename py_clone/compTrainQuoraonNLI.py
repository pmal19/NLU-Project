...
model = BiLSTMCompQuoraonNLI(embedding_dim=EMBEDDING_DIM, hidden_dim=HIDDEN_DIM, vocab_size=len(text_field.vocab), label_size=len(label_field.vocab)-1,\
...
print('Training...')
out_dir = os.path.abspath(os.path.join(os.path.curdir, "runsQuoraonNLI", timestamp))
print("Writing to {}\n".format(out_dir))
