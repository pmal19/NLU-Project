...
def trainEpoch(epoch, break_val, trainLoader, model, optimizer, criterion, inp_dim, batchSize, use_cuda, devLoader, devbatchSize):
    ...
    for batch_idx, (data, target) in enumerate(trainLoader):
        ...
        if batch_idx % 100 == 0:
            ...
            save(model, optimizer, loss, 'compTrainerQuoraOnSST.pth', dev_loss)
...
def main():
    ...
    model = CompNetQuoraonSST(inp_dim, model_dim, num_layers, reverse, bidirectional, dropout, quora_path, training)
